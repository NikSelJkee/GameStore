        ...
        public static async Task SeedAsync(StoreContext context, ILoggerFactory loggerFactory)
        {
            try
            {
                ...
                if (!context.Games.Any())
                {
                    ...
                    {
                        new Game { Title = "The Elder Scrolls III: Morrowind", Description = "RPG by Bethesda", Price = 400, PictureUrl = "images/games/morrowind.png", CompanyId = 1, GenreId = 1},
                        new Game { Title = "The Elder Scrolls IV: Oblivion", Description = "RPG by Bethesda", Price = 600, PictureUrl = "images/games/oblivion.png", CompanyId = 1, GenreId = 1},
                        new Game { Title = "The Elder Scrolls V: Skyrim", Description = "RPG by Bethesda", Price = 800, PictureUrl = "images/games/skyrim.png", CompanyId = 1, GenreId = 1},
